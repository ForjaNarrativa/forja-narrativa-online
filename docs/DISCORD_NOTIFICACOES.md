...
SUPABASE_URL=https://zheplnscvozscbcoludo.supabase.co
...
A URL correta do Supabase para a Forja é `https://zheplnscvozscbcoludo.supabase.co`. Evite copiar a variação antiga com `zhelp...`.
